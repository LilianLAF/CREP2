...
| Fichier | Rôle |
|---|---|
| `fonction_calcul_alpha.py` | Calcul de α dépendant à la fois de **l'année** et de **l'altitude** (combinaison 2.1 + 2.2) |
| `code_atmo_couche_backup.py` | Transfert radiatif multi-couches spectral avec profil vertical et concentrations GES temporelles |
