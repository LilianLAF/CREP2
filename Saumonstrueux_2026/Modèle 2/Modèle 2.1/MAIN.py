# -*- coding: utf-8 -*-
"""
MAIN.py — Modèle 2.1 : bilan énergétique avec alpha dépendant de l'année
(CO₂, CH₄, N₂O, O₃, H₂O avec concentrations de surface variables selon l'année,
profil d'altitude uniforme par gaz).

Lancement : python MAIN.py  (depuis le dossier Modèle 2.1/)
...
from atmosphere import fonction_calcul_alpha as f_c          # Coefficient alpha (5 GES, variation annuelle)
...
def temp(lat=48.85, long=2.35):
    ...
    Différence vs Modèle 1 : alpha est recalculé à partir de 5 gaz à effet de serre
    dont les concentrations de surface dépendent de l'année simulée.
    ...
    # --- Coefficient alpha ---
    # Calculé avec les concentrations de CO₂, CH₄, N₂O, O₃ et H₂O propres à l'année choisie.
    # Les profils verticaux sont uniformes (pas de variation avec l'altitude dans ce modèle).
