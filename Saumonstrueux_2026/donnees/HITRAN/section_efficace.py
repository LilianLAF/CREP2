...
donnees HITRAN (fichier '6a398448.par', format HITRAN2004, largeur fixe)  #a modifier avec le nom du fichier téléchargé
========================================================================
...
HITRAN_FILE = Path(__file__).parent / "6a398448.par"  #a modifier avec le nom du fichier téléchargé
...
if __name__ == "__main__":
    print("Coefficients ajustes sur les donnees HITRAN (fichier 6a398448.par) :")  #a modifier avec le nom du fichier téléchargé
    print("-" * 70)
